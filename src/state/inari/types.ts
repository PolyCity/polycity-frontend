import { ChainId, CurrencyAmount, Token } from '@polycity/sdk'
import { BaseStrategyWithAntiqueBoxTraitHook } from './traits/useAntiqueBoxTrait'
...
export type StrategyHook = BaseStrategyHook | BaseStrategyWithAntiqueBoxTraitHook | BaseStrategyWithHasPermitTokenHook
