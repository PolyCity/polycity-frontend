...
export interface LimitOrderState {
  ...
  readonly fromAntiqueBalance: boolean
...
export default createReducer<LimitOrderState>(initialState, (builder) =>
  builder
    ...
    .addCase(setFromAntiqueBalance, (state, { payload: fromAntiqueBalance }) => {
      state.fromAntiqueBalance = fromAntiqueBalance
    })
