import { Currency, CurrencyAmount, JSBI, Percent, Token, TradeType, Trade as V2Trade } from '@polycity/sdk'
import { DAI, PICHI, USDC } from '../config/tokens'
...
const PERMITTABLE_TOKENS: {
  ...
  [1]: {
    ...
    [PICHI[1].address]: { type: PermitType.AMOUNT, name: 'PolyCityDex' },
  },
  [4]: {
    ...
    [PICHI[4].address]: { type: PermitType.AMOUNT, name: 'PolyCityDex' },
  },
  [3]: {
    [PICHI[3].address]: { type: PermitType.AMOUNT, name: 'PolyCityDex' },
  ...
  [5]: {
    [PICHI[5].address]: { type: PermitType.AMOUNT, name: 'PolyCityDex' },
  },
  [42]: {
    [PICHI[42].address]: { type: PermitType.AMOUNT, name: 'PolyCityDex' },
  },
}
