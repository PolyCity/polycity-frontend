...
const items = (i18n: I18n) => [
  {
    name: i18n._(t`Docs`),
    description: i18n._(t`Documentation for users of Pichi.`),
    href: 'https://docs.sushi.com',
    external: true,
  },
  {
    name: i18n._(t`Dev`),
    description: i18n._(t`Documentation for developers of Pichi.`),
    href: 'https://dev.sushi.com',
    external: true,
  },
  {
    name: i18n._(t`Open Source`),
    description: i18n._(t`Pichi is a supporter of Open Source.`),
