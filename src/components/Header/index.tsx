import { ChainId, Currency, NATIVE, PICHI_ADDRESS } from '@polycity/sdk'
            ...
            <div className="px-4 py-4">
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  <Image src="/logo.png" alt="Pichi" width="32px" height="32px" />
                  <div className="hidden sm:block sm:ml-4">
                    <div className="flex space-x-2">
                      ...
                      {chainId && featureEnabled(Feature.KUSHO, chainId) && (
                        <>
                          <NavLink href={'/lend'}>
                            <a
                              id={`lend-nav-link`}
                ...
                <div className="fixed bottom-0 left-0 z-10 flex flex-row items-center justify-center w-full p-4 lg:w-auto bg-dark-1000 lg:relative lg:p-0 lg:bg-transparent">
                  <div className="flex items-center justify-between w-full space-x-2 sm:justify-end">
                    {chainId && [ChainId.MAINNET].includes(chainId) && library && library.provider.isMetaMask && (
                      <>
                        <QuestionHelper text={i18n._(t`Add xPICHI to your MetaMask wallet`)}>
                          <div
                            ...
                            onClick={() => {
                              if (library && library.provider.isMetaMask && library.provider.request) {
                                ...
                                library.provider
                                  ...
                                  .then((success) => {
                                    if (success) {
                                      console.log('Successfully added XPICHI to MetaMask')
                                    } else {
                    ...
                    {chainId && chainId in PICHI_ADDRESS && library && library.provider.isMetaMask && (
                      <>
                        <QuestionHelper text={i18n._(t`Add PICHI to your MetaMask wallet`)}>
                          <div
                            ...
                            onClick={() => {
                              ...
                              if (library && library.provider.isMetaMask && library.provider.request) {
                                library.provider
                                  ...
                                  .then((success) => {
                                    if (success) {
                                      console.log('Successfully added PICHI to MetaMask')
                                    } else {
                                      throw new Error('Something went wrong.')
                                    }
                                  })
