import { ChainId, Currency, WNATIVE } from '@polycity/sdk'
...
export function getCurrencyLogoUrls(currency) {
  ...
  if (currency.chainId in BLOCKCHAIN) {
    urls.push(
      `https://raw.githubusercontent.com/polycity/assets/master/blockchains/${BLOCKCHAIN[currency.chainId]}/assets/${
        currency.address
      }/logo.png`
    )
    urls.push(
...
const xDaiLogo =
  'https://raw.githubusercontent.com/polycity/assets/master/blockchains/xdai/assets/0xe91D153E0b41518A2Ce8Dd3D7944Fa863463a97d/logo.png'
