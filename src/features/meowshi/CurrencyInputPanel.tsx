          ...
          <div className="flex items-center w-full sm:w-2/5">
            <div className="flex items-center gap-4">
              ...
              <div className="flex flex-col items-start">
                ...
                {(currency === PICHI[ChainId.MAINNET] || currency === XPICHI) && (
                  <Typography
                    variant="xs"
                    className="underline cursor-pointer text-blue"
                    onClick={() => setCurrency(currency === XPICHI ? PICHI[ChainId.MAINNET] : XPICHI, field)}
                  >
                    {currencies[field] === PICHI[ChainId.MAINNET] ? i18n._(t`Use xPICHI`) : i18n._(t`Use PICHI`)}
                  </Typography>
                )}
              </div>
            </div>
