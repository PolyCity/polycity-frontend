              ...
              <div className="flex col-span-2 space-x-4 md:col-span-1">
                ...
                <div className="flex flex-col justify-center">
                  <div>
                    ...
                    <span className={farm?.pair?.type === PairType.KUSHO ? 'font-thin' : 'font-bold'}>
                      {farm?.pair?.token1?.symbol}
                    </span>
                  </div>
                  {farm?.pair?.type === PairType.SWAP && (
                    <div className="text-xs md:text-base text-secondary">PolyCityDex Farm</div>
                  )}
                  {farm?.pair?.type === PairType.KUSHO && (
                    <div className="text-xs md:text-base text-secondary">Kusho Farm</div>
                  )}
                </div>
              </div>
