import { CHAINLINK_ORACLE_ADDRESS, ChainId, Token } from '@polycity/sdk'
...
export class PolyCityDexTWAP0Oracle extends AbstractOracle {
  constructor(pair, chainId: ChainId, tokens?: Token[]) {
    super(pair, chainId, tokens)
    this.name = 'PolyCityDex'
  }
}

export class PolyCityDexTWAP1Oracle extends AbstractOracle {
  constructor(pair, chainId: ChainId, tokens?: Token[]) {
    super(pair, chainId, tokens)
    this.name = 'PolyCityDex'
  }
