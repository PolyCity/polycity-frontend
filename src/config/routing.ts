...
import { ChainId, Currency, Token, WNATIVE } from '@polycity/sdk'
...
export const ADDITIONAL_BASES: {
  ...
  [ChainId.MAINNET]: {
    ...
    '0xe379a60A8FC7C9DD161887fFADF3054790576c8D': [XPICHI], // XPICHI 25 Call [30 June 2021]
...
export const CUSTOM_BASES: {
  ...
  [ChainId.MATIC]: {
    [MATIC.TEL.address]: [MATIC.PICHI, MATIC.AAVE],
  },
}
...
export const COMMON_BASES: ChainTokenList = {
  //[ChainId.MAINNET]: [...WRAPPED_NATIVE_ONLY[ChainId.MAINNET], DAI, USDC, USDT, WBTC, PICHI[ChainId.MAINNET]],
  [ChainId.MATIC]: [
...
export const PINNED_PAIRS: {
  ...
  [ChainId.MAINNET]: [
    [PICHI[ChainId.MAINNET], WNATIVE[ChainId.MAINNET]],
    [
