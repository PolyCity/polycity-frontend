import { ChainId, Ether, PICHI_ADDRESS, Token, WETH9, WNATIVE } from '@polycity/sdk'
...
export const MATIC: { [key: string]: Token } = {
  ...
  PICHI: new Token(ChainId.MATIC, '0xcA84Fc7C2acAB708AC68a63a268330D1454B2742', 18, 'PICHI', 'PolyCityDexToken'),
...
export const XPICHI_CALL = new Token(
  ChainId.MAINNET,
  '0xada279f9301C01A4eF914127a6C2a493Ad733924',
  18,
  'XSUc25-0531',
  'XPICHI 25 Call [31 May 2021]'
)
export const WBTC = new Token(ChainId.MAINNET, '0x2260FAC5E5542a773Aa44fBCfeDf7C193bc2C599', 8, 'WBTC', 'Wrapped BTC')

export const XPICHI = new Token(ChainId.MAINNET, '0x8798249c2E607446EfB7Ad49eC89dD1865Ff4272', 18, 'xPICHI', 'PichiBar')
...
export const CRXPICHI = new Token(
  ChainId.MAINNET,
...
export const AXPICHI = new Token(
  ChainId.MAINNET,
  '0xf256cc7847e919fac9b808cc216cac87ccf2f47a',
  18,
  'aXPICHI',
  'Aave interest bearing XPICHI'
)
...
// PICHI
export const PICHI: ChainTokenMap = {
  [ChainId.MAINNET]: new Token(ChainId.MAINNET, PICHI_ADDRESS[ChainId.MAINNET], 18, 'PICHI', 'PolyCityDexToken'),
  [ChainId.ROPSTEN]: new Token(ChainId.ROPSTEN, PICHI_ADDRESS[ChainId.ROPSTEN], 18, 'PICHI', 'PolyCityDexToken'),
  [ChainId.RINKEBY]: new Token(ChainId.RINKEBY, PICHI_ADDRESS[ChainId.RINKEBY], 18, 'PICHI', 'PolyCityDexToken'),
  [ChainId.GÖRLI]: new Token(ChainId.GÖRLI, PICHI_ADDRESS[ChainId.GÖRLI], 18, 'PICHI', 'PolyCityDexToken'),
  [ChainId.KOVAN]: new Token(ChainId.KOVAN, PICHI_ADDRESS[ChainId.KOVAN], 18, 'PICHI', 'PolyCityDexToken'),
  [ChainId.MATIC]: new Token(ChainId.MATIC, PICHI_ADDRESS[ChainId.MATIC], 18, 'PICHI', 'PolyCityDexToken'),
  [ChainId.FANTOM]: new Token(ChainId.FANTOM, PICHI_ADDRESS[ChainId.FANTOM], 18, 'PICHI', 'PolyCityDexToken'),
  [ChainId.XDAI]: new Token(ChainId.XDAI, PICHI_ADDRESS[ChainId.XDAI], 18, 'PICHI', 'PolyCityDexToken'),
  [ChainId.BSC]: new Token(ChainId.BSC, PICHI_ADDRESS[ChainId.BSC], 18, 'PICHI', 'PolyCityDexToken'),
  [ChainId.ARBITRUM]: new Token(ChainId.ARBITRUM, PICHI_ADDRESS[ChainId.ARBITRUM], 18, 'PICHI', 'PolyCityDexToken'),
  [ChainId.AVALANCHE]: new Token(ChainId.AVALANCHE, PICHI_ADDRESS[ChainId.AVALANCHE], 18, 'PICHI', 'PolyCityDexToken'),
  [ChainId.OKEX]: new Token(ChainId.OKEX, PICHI_ADDRESS[ChainId.OKEX], 18, 'PICHI', 'PolyCityDexToken'),
  [ChainId.HARMONY]: new Token(ChainId.HARMONY, PICHI_ADDRESS[ChainId.HARMONY], 18, 'PICHI', 'PolyCityDexToken'),
  [ChainId.HECO]: new Token(ChainId.HECO, PICHI_ADDRESS[ChainId.HECO], 18, 'PICHI', 'PolyCityDexToken'),
}
