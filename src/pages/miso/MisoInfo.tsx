  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="grid grid-cols-12 mt-6 divide-x divide-white divide-opacity-50">
        ...
        <div className="flex flex-col col-span-4">
          <div className="mx-auto">
            ...
            <div className="text-base font-bold text-white md:text-xl">{`${minRaised} $PICHI`}</div>
      ...
      <div className="flex flex-col mt-6">
        <div>About</div>
        <div>
          The Trident NFT is introduced as a celebratory piece for the announcement and upcoming release of Pichi’s
