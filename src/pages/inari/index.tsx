...
import useStakePichiToAntiqueStrategy from '../../state/inari/strategies/useStakePichiToAntiqueStrategy'
...
const Inari = () => {
  ...
  useEffect(() => {
    dispatch(setStrategy(stakePichiToAntiqueStrategy))
      ...
      <Container maxWidth="5xl" className="flex flex-col gap-8 px-4 py-8">
        <div className="flex items-center gap-8">
          ...
          <div className="flex flex-col">
            ...
            <Typography>
              {i18n._(t`Take your PICHI and invest in various strategies with one click! Earn extra yields with AntiqueBox, use as
