...
const TOOLS = (i18n: I18n) => [
  {
    id: 1,
    name: 'MEOWSHI',
    description: i18n._(t`Redenominate xPICHI into MEOWSHI`),
    href: '/tools/meowshi',
  },
  {
    id: 2,
    name: 'INARI',
    description: 'Deposit PICHI in various strategies & platforms in one click!',
    href: '/inari',
  },
]
...
export default function Tools() {
  ...
  return (
    <Container id="tools-page" className="py-4 space-y-4 md:py-8 lg:py-12" maxWidth="xl">
      <Head>
        <title>Tools | Pichi</title>
        <meta key="description" name="description" content="PolyCityDex tools..." />
      </Head>
