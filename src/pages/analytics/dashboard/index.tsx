import { useBlock, useEthPrice, useNativePrice, usePichiPairs, useTokens } from '../../../services/graph'
...
export default function Dashboard(): JSX.Element {
  ...
  const pairs1d = usePichiPairs({ block: block1d })
  const pairs1w = usePichiPairs({ block: block1w })
      ...
      farms
        ?.map((farm) => ({
          pair: {
            ...
            type: farm.pair.symbol ? 'Kusho Farm' : 'Pichi Farm',
          },
    ...
    <AnalyticsContainer>
      <Background background="dashboard">
        <div className="grid items-center justify-between grid-cols-2">
          <div>
            <div className="text-3xl font-bold text-high-emphesis">Pichi Analytics</div>
            <div className="">
