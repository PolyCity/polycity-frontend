...
import { useBlock, useNativePrice, usePichiPairs, useTransactions } from '../../../services/graph'
...
export default function Pair() {
  ...
  const pair = usePichiPairs({ subset: [id] })?.[0]
  const pair1d = usePichiPairs({ subset: [id], block: block1d, shouldFetch: !!block1d })?.[0]
  const pair2d = usePichiPairs({ subset: [id], block: block2d, shouldFetch: !!block2d })?.[0]
        ...
        <div className="items-center -mt-4 space-y-6">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <div className="text-xs text-secondary">Pichi Liquidity Pool</div>
            </div>
