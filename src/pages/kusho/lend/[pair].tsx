import { Deposit, Withdraw } from '../../../features/kusho'
...
export default function Pair() {
  ...
  return (
    <div id={`lend-${router.query.pair}-page`}>
      <Head>
        <title>Lend {pair.asset.tokenInfo.symbol} | Pichi</title>
        <meta key="description" name="description" content={`Lend ${pair.asset.tokenInfo.symbol} on Kusho`} />
      </Head>
      <Card
          ...
          <div className="flex-col space-y-2">
            ...
            <div className="flex justify-between">
              ...
              <div className="flex flex-row text-lg text-high-emphesis">
                ...
                <QuestionHelper
                  text={i18n._(
                    t`AntiqueBox strategies can create yield for your liquidity while it is not lent out. This token does not yet have a strategy in the AntiqueBox.`
                  )}
                />
              </div>
            </div>
