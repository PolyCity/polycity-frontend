import Provider, { useKushoPairs } from '../../../features/kusho/context'
...
import ListHeaderWithSort from '../../../features/kusho/ListHeaderWithSort'
import MarketHeader from '../../../features/kusho/MarketHeader'
...
function Borrow() {
  ...
  return (
    <>
      <Head>
        <title>{i18n._(t`Borrow`)} | Pichi</title>
        <meta
          key="description"
          name="description"
          content="Kusho is a lending and margin trading platform, built upon AntiqueBox, which allows for anyone to create customized and gas-efficient markets for lending, borrowing, and collateralizing a variety of DeFi tokens, stable coins, and synthetic assets."
        />
      </Head>
