  ...
  return (
    <Fragment>
      <Head>
        ...
        />
        <title key="title">PICHI</title>

        <meta
          key="description"
          name="description"
          content="Be a DeFi Chef with Pichi. Swap, earn, stack yields, lend, borrow, leverage all on one decentralized, community driven platform. Welcome home to DeFi"
        />

        <meta name="application-name" content="PICHI App" />
        <meta name="apple-mobile-web-app-capable" content="yes" />
        <meta name="apple-mobile-web-app-status-bar-style" content="black-translucent" />
        <meta name="apple-mobile-web-app-title" content="PICHI App" />
        ...
        <meta key="twitter:title" name="twitter:title" content="PICHI App" />
        ...
        <meta key="twitter:creator" name="twitter:creator" content="@PolyCityDex" />
        <meta key="og:type" property="og:type" content="website" />
        <meta key="og:site_name" property="og:site_name" content="PICHI App" />
