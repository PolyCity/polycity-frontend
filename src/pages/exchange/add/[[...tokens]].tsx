...
import { Currency, CurrencyAmount, Percent, WNATIVE, currencyEquals } from '@polycity/sdk'
...
export default function Add() {
  ...
  return (
    <>
      <Head>
        <title>Add Liquidity | Pichi</title>
        <meta
          key="description"
          name="description"
          content="Add liquidity to the PolyCityDex AMM to enable gas optimised and low slippage trades across countless networks"
        />
      </Head>
