...
export const poolsQuery = gql`
  query poolsQuery(
    ...
    $block: Block_height
    $where: Pool_filter! = { allocPoint_gt: 0, accPichiPerShare_gt: 0 }
  ) {
    pools(
      first: $first
      skip: $skip
...
export const masterChefV1PichiPerBlockQuery = gql`
  query masterChefV1PichiPerBlock($id: String! = "0xc2edad668740f1aa35e4d8f227fb8e17dca888cd") {
    masterChef(id: $id) {
      id
      sushiPerBlock
    }
